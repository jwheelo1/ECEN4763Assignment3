...
clean:
	...
	rm -rf test/graph/__pycache__ # remove compiled python directory
	rm -rf structures/graph/__pycache__ # remove compiled python directory
	rm -rf test/hashmap/__pycache__ # remove compiled python directory
	rm -rf structures/hashmap/__pycache__ # remove compiled python directory
